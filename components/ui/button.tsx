...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-all focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 rounded-[0.7rem] border-2 border-[rgb(50,50,50)] border-b-[5px] shadow-[0px_2px_8px_0px_rgb(158,129,254)] cursor-pointer duration-300 hover:brightness-110 hover:shadow-[0px_4px_12px_0px_rgb(158,129,254)] hover:scale-105 active:scale-95 active:duration-75",
  {
    variants: {
      variant: {
